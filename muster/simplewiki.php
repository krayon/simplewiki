...
*/
	...
	*/
	...
	/**
	Set blockdef handler (and other tag type handlers). The blockdef handler is called for any known blockdef, with a param of the blockdef node.
	@param method $handler typically in the form <i> array(objectref,'methodname') </i>
	@return void
	*/
	...
	{
		$emitter = $this->_emitter;
		$emitter->register_vblockdef_handler($handler);
	}
	public function register_itagdef_handler($handler)
	{
		$emitter = $this->_emitter;
		$emitter->register_itagdef_handler($handler);
	}
	public function register_vtagdef_handler($handler)
	{
		$emitter = $this->_emitter;
		$emitter->register_vtagdef_handler($handler);
	}
