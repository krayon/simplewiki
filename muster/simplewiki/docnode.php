...
/**@{@name Types of nodes */
	...
	*/
	...
	/** itagdef node (\<itagdef>).
	\b Parsed properties: \b decoration, \b itag, \b source_markup, \b source_close_markup
	\b Added by node emitter: \b opentag_head = "\n<itag", \b opentag_tail = "/>", \b closetag = "\n</itag>", \b elementcontent set from child emitters
	\b knowntag = <boolean>
	...
	@sa Muster_SimpleWiki_Emitter::_span_emit
	*/
	const ITAGDEF = 'itagdef';

	
	/** vtagdef node (\<vtagdef>).
	\b Parsed properties: \b decoration, \b itag, \b source_markup
	\b Added by node emitter: \b opentag_head = "\n<itag", \b opentag_tail = "/>", \b closetag = "\n</itag>", \b elementcontent set from child emitters
	\b knowntag = <boolean>
	...
	@sa Muster_SimpleWiki_Emitter::_span_emit
	*/
	const VTAGDEF = 'vtagdef';

	/** vblockdef node (\<vblockdef>).
	\b Parsed properties: \b decoration, \b vblockdef, \b source_markup
	\b Added by node emitter: \b opentag_head = "\n<itag", \b opentag_tail = "/>", \b closetag = "\n</itag>", \b elementcontent set from child emitters
	\b knowntag = <boolean>
